...
test_wall = Wall(255,10,100,100,100,10,500)
walls = [ Wall( 255,10,100,20,20,10,500),
         Wall( 0,10,100,110,110,500,10),
         Wall(255,10,100,250,250,10,500),
         Wall(100, 0 ,50, 500,250, 10,200)]
...
while not game_over:
    ...
    if pygame.sprite.collide_rect(player,gold):
        finish = True
        window.blit(text_win,(width/4 , height/4))
        money.play()
